<div x-show="deleteConfirm" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
     aria-modal="true" wire:key="{{ randAlpha() }}">
            ...
            <div class="p-6 text-center">
                ...
                <div class="flex flex-wrap gap-2 justify-center">
                    <button type="button"
                            ...
                            id="remove-button" wire:click="destroyData" wire:loading.attr="disabled"
                            wire:target="destroyData">
                        Ya, Saya yakin
                        <div class="animate-spin inline-block ms-1 w-3 h-3 border-[2px] border-current border-t-transparent rounded-full"
                             role="status" aria-label="loading" wire:loading wire:target="destroyData">
