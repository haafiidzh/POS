    ...
    <form wire:submit.prevent="store">
        <div class="flex flex-col md:flex-row gap-6">
            <div class="md:w-8/12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0 pb-1">Tentang Artikel</h5>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <labelfor="">Subjek</label>
                            <textarea class="form-input" name="subject" autocomplete="subject" style="height: 65px; resize:none"
            ...
            <div class="md:w-4/12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0 pb-1">Pengaturan Artikel</h5>
                    </div>

                    <div class="card-body">
                        <div class="form-group">
                            <livewire:common::utils.filepond :compress="true" />
                        ...
                        <div class="form-group">
                            ...
                            <livewire:common::utils.tagify.tag placeholder="Ketikkan tag disini..." />
