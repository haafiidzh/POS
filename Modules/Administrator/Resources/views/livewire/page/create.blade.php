<div>
    ...
    <div class="card">
        <div class="p-6">
            <h5 class="card-title mb-0 pb-1">Tambah Halaman Web</h5>
            <p>Buat halaman web baru pada website. Halaman ini adalah halaman yang dapat diakses oleh publik.</p>
            <form wire:submit.prevent="store">
                ...
                <div class="form-group">
                    ...
                    <div class="custom-control custom-switch">
                        ...
                        for="is_active">Aktifkan Halaman?</label>
                        <br>
                        @error('is_active')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
