<div x-data="{
        ...
        <div class="md:col-span-7 flex flex-col gap-6">
            <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    @can('create.retribution-category', 'web')
                        ...
                        <div wire:sortable.item="{{ $group->id }}" wire:key="group-{{ $group->id }}"
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex mx-2">
                                    ...
                                    @can('update.retribution-category', 'web')
                                    ...
                                    @can('delete.retribution-category', 'web')
    ...
    <livewire:administrator::retribution-category.create />
    <livewire:administrator::retribution-category.edit />
