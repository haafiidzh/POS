<div x-data="{deleteConfirm: false, createModal: true, editModal: true}">
    <div class="grid md:grid-cols-12 gap-6">
        <div class="md:col-span-7 flex flex-col gap-6">
            <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                    <h4 class="card-title">Daftar Kategori</h4>
                    @can('create.article-category', 'web')
                        ...
                        <div wire:sortable.item="{{ $group->id }}" wire:key="group-{{ $group->id }}"
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex mx-2">
                                    ...
                                    @can('update.article-category', 'web')
                                    ...
                                    @can('delete.article-category', 'web')
    ...
    <livewire:administrator::post-category.create />
    <livewire:administrator::post-category.edit />
