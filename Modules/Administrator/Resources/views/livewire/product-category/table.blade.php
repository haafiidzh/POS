<div x-data="{
        ...
        <div class="md:col-span-7 flex flex-col gap-6">
            <div class="card p-6">
                <div class="flex justify-between items-center mb-4">
                    ...
                    @can('create.product-category', 'web')
                        ...
                        <div wire:sortable.item="{{ $group->id }}" wire:key="group-{{ $group->id }}"
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class="flex mx-2">
                                    ...
                                    @can('update.product-category', 'web')
                                    ...
                                    @can('delete.product-category', 'web')
    ...
    <livewire:administrator::product-category.create />
    <livewire:administrator::product-category.edit />
