...
@section('content')
    <x-common::utils.breadcrumb title="Pengaturan">
        <x-common::utils.breadcrumb-item href="{{ route('administrator.e-commerce.setting.general.index') }}"
                                         page="Pengaturan" />
    ...
    <livewire:administrator::ecommerce-setting.edit :app-setting="$app_setting" />
@endsection
