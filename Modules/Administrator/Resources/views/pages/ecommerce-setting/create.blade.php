    ...
    <div id="main-wrapper">
        <x-common::utils.breadcrumb title="Pengaturan">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="{{ route('administrator.setting.main.index') }}">Pengaturan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Tambah</li>

            <x-slot name="button">
                <a href="{{ route('administrator.setting.main.index') }}" class="btn bg-primary">
        ...
        <div class="row">
            <div class="col-md-8">
                <livewire:administrator::ecommerce-setting.create />
            </div>
        </div>
    </div>
@endsection
