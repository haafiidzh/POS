...
namespace Modules\Administrator\Livewire\PostCategory;

use Exception;
use Livewire\Component;
use Livewire\WithPagination;
use Modules\Administrator\Livewire\PostCategory\Create;
use Modules\Administrator\Livewire\PostCategory\Edit;
...
class Table extends Component
{
    ...
    public function destroy()
    {
        try {
            ...
            if (!$category) {
                throw new Exception('Kategori artikel tidak ditemukan, kategori gagal dihapus.');
            }
            ...
            return $this->dispatchSuccess('Kategori artikel berhasil dihapus.', true);
    ...
    {
        return view('administrator::livewire.post-category.table', [
