...
namespace Modules\Administrator\Livewire\ProductCategory;

use Exception;
use Livewire\Component;
use Livewire\WithPagination;
use Modules\Administrator\Livewire\ProductCategory\Create;
use Modules\Administrator\Livewire\ProductCategory\Edit;
...
class Table extends Component
{
    ...
    public function destroy()
    {
        try {
            ...
            if (!$category) {
                throw new Exception('Kategori produk tidak ditemukan, kategori gagal dihapus.');
            }
            ...
            return $this->dispatchSuccess('Kategori produk berhasil dihapus.', true);
    ...
    {
        return view('administrator::livewire.product-category.table', [
