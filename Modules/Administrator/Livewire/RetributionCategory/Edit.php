...
class Edit extends Component
{
    ...
    public ?string $group = 'retributions';
    ...
    public function update()
    {
        ...
        try {
            ...
            return $this->dispatchSuccess('Kategori Retribusi berhasil diperbarui.');
        } catch (Exception $exception) {
            return $this->dispatchError($exception->getMessage());
        }
    }
    ...
    {
        return view('administrator::livewire.retribution-category.edit', [
