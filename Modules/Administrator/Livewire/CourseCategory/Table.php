...
namespace Modules\Administrator\Livewire\CourseCategory;

use Exception;
use Livewire\Component;
use Livewire\WithPagination;
use Modules\Administrator\Livewire\CourseCategory\Create;
use Modules\Administrator\Livewire\CourseCategory\Edit;
...
class Table extends Component
{
    ...
    public function destroy()
    {
        try {
            ...
            if (!$category) {
                throw new Exception('Kategori kelas tidak ditemukan, kategori gagal dihapus.');
            }
            ...
            return $this->dispatchSuccess('Kategori kelas berhasil dihapus.', true);
    ...
    {
        return view('administrator::livewire.course-category.table', [
