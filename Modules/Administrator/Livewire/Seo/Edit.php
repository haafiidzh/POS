...
class Edit extends Component
{
    ...
    {
        try {
            $setting = AppSetting::find($this->seo);

            if (!$setting) {
                throw new Exception('Pengaturan tidak ditemukan, pengaturan gagal di-edit.');
            }
    

            // Mengatur properti untuk komponen Livewire
            ...
            // Memanggil metode untuk menangani kesalahan
    ...
    {
        return view('administrator::livewire.seo.edit');
    }
}
