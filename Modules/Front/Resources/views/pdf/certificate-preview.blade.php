...
<body>
    ...
    <script src="{{ asset('assets/front/libs/html2pdf/html2pdf.bundle.min.js') }}"></script>
    ...
    <script type="text/javascript">
        (function() {
            ...
            document.addEventListener("DOMContentLoaded", function() {
                ...
                element.onload = () => {
                    // const content = element.contentDocument.body.querySelector('.content');
                    const content = element.contentDocument.body;
                    // html2canvas(content).then((canvas) => {
                    // html2pdf().set(opt).from(content).toContainer().save()
                    // });
                    // document.body.appendChild(html2pdf().set(opt).from(content).toCanvas());
                    ...
                    if (mode == 'download') {
                        html2pdf().set(opt).from(content).toCanvas();
