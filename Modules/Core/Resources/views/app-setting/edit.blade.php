    ...
    <div id="main-wrapper">
        <x-admin.components.breadcrumb page="Pengaturan">
            <li class="breadcrumb-item active" aria-current="page">
                <a href="{{ route('core.app-setting.index') }}">Pengaturan</a>
            </li>
            <li class="breadcrumb-item active" aria-current="page">Edit</li>

            <x-slot name="button">
                <a href="{{ route('core.app-setting.index') }}" class="btn bg-primary">
        ...
        <div class="row">
            <div class="col-md-8">
                <livewire:common::app-setting.edit :appsetting="$appsetting" />
            </div>
        </div>
    </div>
@endsection
