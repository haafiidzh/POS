...
Z`;
    ...
    (() => {
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */
        var shepherd_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__( /*! shepherd.js */ "./node_modules/shepherd.js/dist/js/shepherd.esm.js");
        /*
        ...
        */
        ...
        var tour = new shepherd_js__WEBPACK_IMPORTED_MODULE_0__["default"].Tour({
            defaultStepOptions: {
                cancelIcon: {
                    enabled: true
                },
        ...
        if (document.querySelector('#tour-card-one')) tour.addStep({
            title: 'Card One',
            text: "You can find here status of user who's currently online",
            attachTo: {
        ...
        if (document.querySelector('#tour-card-two')) tour.addStep({
            title: 'Card Two',
            text: "You can find here status of user who's currently online",
            attachTo: {
        ...
        if (document.querySelector('#tour-card-three')) tour.addStep({
            title: 'Card Three',
            text: "You can find here status of user who's currently online",
            attachTo: {
        ...
        if (document.querySelector('#tour-card-four')) tour.addStep({
            title: 'Card Four',
            text: "You can find here status of user who's currently online",
            attachTo: {
