...
var GoogleMap = /*#__PURE__*/function () {
  ...
  _createClass(GoogleMap, [{
    key: "initBasicGoogleMap",
    value: function initBasicGoogleMap() {
      var map = new (gmaps__WEBPACK_IMPORTED_MODULE_0___default())({
        div: '#gmaps-basic',
        lat: -12.043333,
        lng: -77.028333
      });
    ...
    key: "initMarkerGoogleMap",
    value: function initMarkerGoogleMap() {
      var map = new (gmaps__WEBPACK_IMPORTED_MODULE_0___default())({
        div: '#gmaps-markers',
        lat: -12.043333,
        lng: -77.028333
    ...
    key: "initStreetViewGoogleMap",
    value: function initStreetViewGoogleMap() {
      var panorama = gmaps__WEBPACK_IMPORTED_MODULE_0___default().createPanorama({
        el: '#panorama',
        lat: 42.3455,
        lng: -71.0983
      });
    ...
    key: "initUltraLightMap",
    value: function initUltraLightMap() {
      var map = new (gmaps__WEBPACK_IMPORTED_MODULE_0___default())({
        div: '#ultra-light',
        lat: 42.3455,
        lng: -71.0983,
