...
document.querySelectorAll('[data-toggle="input-mask"]').forEach(function (e) {
  var maskFormat = e.getAttribute('data-mask-format').toString().replaceAll('0', '9');
  e.setAttribute("data-mask-format", maskFormat);
  var im = new (inputmask__WEBPACK_IMPORTED_MODULE_0___default())(maskFormat);
  im.mask(e);
});
})();
