...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(html5Slider, {
  start: [10, 30],
  connect: true,
  range: {
    'min': -20,
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(nonLinearSlider, {
  connect: true,
  behaviour: 'tap',
  start: [500, 4000],
  range: {
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(slider1, {
  start: 60,
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(slider2, {
  start: 80,
  animate: false,
  range: {
    min: 50,
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(hidingTooltipSlider, {
  range: {
    min: 0,
    max: 100
  },
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(toggleSlider, {
  orientation: "vertical",
  start: 0,
  range: {
    'min': [0, 1],
...
nouislider__WEBPACK_IMPORTED_MODULE_0__["default"].create(softSlider, {
  start: 50,
  range: {
    min: 0,
    max: 100
