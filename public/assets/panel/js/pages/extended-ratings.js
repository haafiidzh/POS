...
// basic-rater
if (document.querySelector('#basic-rater')) var basicRating = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
  starSize: 22,
  rating: 3,
...
// rater-step
if (document.querySelector('#rater-step')) var starRatingStep = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
  starSize: 22,
  rating: 1.5,
...
if (document.querySelector('#rater-message')) var starRatingmessage = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
...
// rater-unlimitedstar
if (document.querySelector('#rater-unlimitedstar')) var starRatingunlimited = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
  starSize: 22,
  max: 5,
  readOnly: true,
  rating: 3.5,
...
// rater-onhover
if (document.querySelector('#rater-onhover')) var starRatinghover = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
  starSize: 22,
  rating: 1,
...
// rater-reset
if (document.querySelector('#raterreset')) var starRatingreset = rater_js__WEBPACK_IMPORTED_MODULE_0___default()({
  starSize: 22,
  rating: 2,
