...
/***/ "./resources/dist/panel/js/pages/extended-daterangepicker.js":
/*!*******************************************************************!*\
  !*** ./resources/dist/panel/js/pages/extended-daterangepicker.js ***!
  \*******************************************************************/
...
/* harmony import */ var _vendor_vanilla_datetimerange_vanilla_datetimerange_picker__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../vendor/vanilla-datetimerange/vanilla-datetimerange-picker */ "./resources/dist/panel/vendor/vanilla-datetimerange/vanilla-datetimerange-picker.js");
/* harmony import */ var _vendor_vanilla_datetimerange_vanilla_datetimerange_picker__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_vendor_vanilla_datetimerange_vanilla_datetimerange_picker__WEBPACK_IMPORTED_MODULE_0__);
/**
...
/***/ "./resources/dist/panel/vendor/vanilla-datetimerange/vanilla-datetimerange-picker.js":
/*!*******************************************************************************************!*\
  !*** ./resources/dist/panel/vendor/vanilla-datetimerange/vanilla-datetimerange-picker.js ***!
  \*******************************************************************************************/
/***/ (() => {
...
var DateRangePicker;
(function () {
  DateRangePicker = function DateRangePicker(element, options, cb) {
    //default settings for options
    this.parentEl = document.body;
    if (typeof element === 'string') this.element = document.getElementById(element);else this.element = element;
    ...
    if (_typeof(options.ranges) === 'object') {
      var rangesKeys = Object.keys(options.ranges);
      for (var i = 0; i < rangesKeys.length; ++i) {
        var _range = rangesKeys[i];
        if (typeof options.ranges[_range][0] === 'string') start = moment(options.ranges[_range][0], this.locale.format);else start = moment(options.ranges[_range][0]);
        if (typeof options.ranges[_range][1] === 'string') end = moment(options.ranges[_range][1], this.locale.format);else end = moment(options.ranges[_range][1]);
    ...
    if (_typeof(options.ranges) === 'object') this.container.classList.add('show-ranges');
    ...
    var applyBtnEl = this.container.querySelector('.applyBtn');
    var cancelBtnEl = this.container.querySelector('.cancelBtn');
    ...
    */
    ...
    var drpButtonsEl = this.container.querySelector('.drp-buttons');
  ...
  DateRangePicker.prototype = {
    ...
    updateView: function updateView() {
      if (this.timePicker) {
        ...
        var selectElList = this.container.querySelectorAll('.right .calendar-time select');
        if (!this.endDate) {
          ...
          for (var _i = 0; _i < selectElList.length; ++_i) {
            selectElList[_i].disabled = false;
            selectElList[_i].classList.remove('disabled');
          }
        }
      }
      if (this.endDate) jq.html(this.container.querySelector('.drp-selected'), this.startDate.format(this.locale.format) + this.locale.separator + this.endDate.format(this.locale.format));
      this.updateMonthsInView();
    ...
    updateCalendars: function updateCalendars() {
      if (!this.clickPrevProxy) this.clickPrevProxy = function (e) {
        this.clickPrev(e);
      }.bind(this);
      if (!this.clickNextProxy) this.clickNextProxy = function (e) {
        this.clickNext(e);
      }.bind(this);
      if (!this.clickDateProxy) this.clickDateProxy = function (e) {
        this.clickDate(e);
      }.bind(this);
      if (!this.hoverDateProxy) this.hoverDateProxy = function (e) {
        this.hoverDate(e);
      }.bind(this);
      if (!this.monthOrYearChangedProxy) this.monthOrYearChangedProxy = function (e) {
        this.monthOrYearChanged(e);
      }.bind(this);
      if (!this.timeChangedProxy) this.timeChangedProxy = function (e) {
        this.timeChanged(e);
      }.bind(this);
      ...
      --------------------------------------------------------------------------------------
      */
      var drpCalendarElList = this.container.querySelectorAll('.drp-calendar');
      ...
      for (var i = 0; i < rangesLiElList.length; ++i) rangesLiElList[i].classList.remove('active');
    ...
    renderCalendar: function renderCalendar(side) {
      ...
      for (var _i2 = 0; _i2 < this.locale.daysOfWeek.length; ++_i2) {
        html += '<th>' + this.locale.daysOfWeek[_i2] + '</th>';
      }
      html += '</tr>';
      html += '</thead>';
      html += '<tbody>';
    ...
    move: function move() {
      ...
      if (!(this.parentEl.tagName === 'BODY')) {
        var parentElOffset = jq.offset(this.parentEl);
        parentOffset = {
      ...
      var elementOffset = jq.offset(this.element);
      switch (drops) {
        case 'auto':
      ...
      if (drops == 'up') this.container.classList.add('drop-up');else this.container.classList.remove('drop-up');
      if (this.opens == 'left') {
    ...
    show: function show(e) {
      ...
      if (!this._outsideClickProxy) this._outsideClickProxy = function (e) {
        this.outsideClick(e);
      }.bind(this);
      ...
      if (!this.moveProxy) this.moveProxy = function (e) {
        this.move(e);
      }.bind(this);
      ...
      this.move();
      this.element.dispatchEvent(new CustomEvent('show.daterangepicker', {
        bubbles: true,
        detail: this
      }));
      this.isShowing = true;
    ...
    hide: function hide(e) {
      ...
      this.container.style.display = 'none';
      this.element.dispatchEvent(new CustomEvent('hide.daterangepicker', {
        bubbles: true,
        detail: this
      }));
      this.isShowing = false;
    ...
    outsideClick: function outsideClick(e) {
      ...
      if (
      // ie modal dialog fix
      e.type == "focusin" || target.closest(jq.getSelectorFromElement(this.element)) || target.closest(jq.getSelectorFromElement(this.container)) || target.closest('.calendar-table')) return;
      this.hide();
      this.element.dispatchEvent(new CustomEvent('outsideClick.daterangepicker', {
        bubbles: true,
        detail: this
      }));
    },
    showCalendars: function showCalendars() {
      this.container.classList.add('show-calendar');
      this.move();
      this.element.dispatchEvent(new CustomEvent('showCalendar.daterangepicker', {
        bubbles: true,
        detail: this
      }));
    },
    hideCalendars: function hideCalendars() {
      ...
      this.element.dispatchEvent(new CustomEvent('hideCalendar.daterangepicker', {
        bubbles: true,
        detail: this
      }));
    },
    ...
    hoverDate: function hoverDate(e) {
      ...
      if (!this.endDate) {
        var tdElList = this.container.querySelectorAll('.drp-calendar tbody td');
        for (var i = 0; i < tdElList.length; ++i) {
    ...
    calculateChosenLabel: function calculateChosenLabel() {
      ...
      var rangesKey = Object.keys(this.ranges);
      for (var i = 0; i < rangesKey.length; ++i) {
        var _range2 = this.ranges[rangesKey[i]];
        if (this.timePicker) {
          var format = this.timePickerSeconds ? "YYYY-MM-DD HH:mm:ss" : "YYYY-MM-DD HH:mm";
          //ignore times when comparing dates if time picker seconds is not enabled
          if (this.startDate.format(format) == _range2[0].format(format) && this.endDate.format(format) == _range2[1].format(format)) {
            customRange = false;
            var rangesLiList = this.container.querySelectorAll('.ranges li');
          ...
          if (this.startDate.format('YYYY-MM-DD') == _range2[0].format('YYYY-MM-DD') && this.endDate.format('YYYY-MM-DD') == _range2[1].format('YYYY-MM-DD')) {
            customRange = false;
            var _rangesLiList = this.container.querySelectorAll('.ranges li');
            _rangesLiList[i].classList.add('active');
            this.chosenLabel = _rangesLiList[i].dataset.rangeKey;
            break;
          }
        }
      }
      if (customRange) {
        if (this.showCustomRangeLabel) {
          var rangesLiLastEl = jq.findLast(this.container.querySelectorAll('.ranges li'));
          if (rangesLiLastEl) {
    ...
    clickApply: function clickApply(e) {
      this.hide();
      e.target.dispatchEvent(new CustomEvent('apply.daterangepicker', {
        bubbles: true,
        detail: this
      }));
    },
    clickCancel: function clickCancel(e) {
      ...
      this.hide();
      e.target.dispatchEvent(new CustomEvent('cancel.daterangepicker', {
        bubbles: true,
        detail: this
      }));
    },
    ...
    updateRanges: function updateRanges(newRanges) {
      if (_typeof(newRanges) === 'object') {
        jq.off(this.container.querySelector('.ranges'), 'click', 'li', this.clickRangeProxy);
        this.ranges = [];
        var rangesKeys = Object.keys(newRanges);
        for (var i = 0; i < rangesKeys.length; ++i) {
          var _range3 = rangesKeys[i];
          if (typeof newRanges[_range3][0] === 'string') start = moment(newRanges[_range3][0], this.locale.format);else start = moment(newRanges[_range3][0]);
          if (typeof newRanges[_range3][1] === 'string') end = moment(newRanges[_range3][1], this.locale.format);else end = moment(newRanges[_range3][1]);
        ...
        list += '</ul>';
        var rangeNode = this.container.querySelector('.ranges');
  ...
  var jq = {
    addClassSub: function addClassSub(el, classes) {
      var classsList = classes.split(' ');
      for (var i = 0; i < classsList.length; ++i) {
        el.classList.add(classsList[i].trim());
      }
    },
    addClass: function addClass(el, classes) {
      if (!el) return;
      if (typeof el.length === 'number') for (var i = 0; i < el.length; ++i) jq.addClassSub(el[i], classes);else jq.addClassSub(el, classes);
    },
    findLast: function findLast(el) {
      if (!el) return null;
      if (typeof el.length === 'number') {
        if (el.length > 0) return el[el.length - 1];else return null;
      } else return el;
    },
    findSelectedOption: function findSelectedOption(el) {
    ...
    offSub: function offSub(el, event, listener) {
      if (typeof el.length === 'number') for (var i = 0; i < el.length; ++i) el[i].removeEventListener(event, listener);else el.removeEventListener(event, listener);
    },
    off: function off(el, event, param1, param2) {
      if (!el) return;
      if (typeof param1 === 'function') {
        ...
        // param is selector
        if (typeof el.length === 'number') for (var i = 0; i < el.length; ++i) jq.offSub(el[i].querySelectorAll(param1), event, param2);else jq.offSub(el.querySelectorAll(param1), event, param2);
      }
    },
    onSub: function onSub(el, event, listener) {
      if (typeof el.length === 'number') for (var i = 0; i < el.length; ++i) el[i].addEventListener(event, listener);else el.addEventListener(event, listener);
    },
    on: function on(el, event, param1, param2) {
      if (!el) return;
      if (typeof param1 === 'function') {
        // param1 is listener
        ...
        // param1 is selector
        if (typeof el.length === 'number') for (var i = 0; i < el.length; ++i) jq.onSub(el[i].querySelectorAll(param1), event, param2);else jq.onSub(el.querySelectorAll(param1), event, param2);
      }
    }
  };
})();
...
/******/ 		var installedChunks = {
/******/ 			"/assets/panel/js/pages/extended-daterangepicker": 0,
/******/ 			"assets/panel/css/app": 0,
/******/ 			"assets/panel/css/plugins": 0,
/******/ 			"assets/panel/css/icons": 0
/******/ 		};
/******/ 		
...
/******/ 	__webpack_require__.O(undefined, ["assets/panel/css/app","assets/panel/css/plugins","assets/panel/css/icons"], () => (__webpack_require__("./resources/dist/panel/js/pages/extended-daterangepicker.js")))
/******/ 	__webpack_require__.O(undefined, ["assets/panel/css/app","assets/panel/css/plugins","assets/panel/css/icons"], () => (__webpack_require__("./resources/dist/panel/scss/app.scss")))
/******/ 	__webpack_require__.O(undefined, ["assets/panel/css/app","assets/panel/css/plugins","assets/panel/css/icons"], () => (__webpack_require__("./resources/dist/panel/scss/icons.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/panel/css/app","assets/panel/css/plugins","assets/panel/css/icons"], () => (__webpack_require__("./resources/dist/panel/scss/plugins.scss")))
