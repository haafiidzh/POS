...
/***/ "./resources/dist/panel/js/main.js":
/*!*****************************************!*\
  !*** ./resources/dist/panel/js/main.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _frostui_tailwindcss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @frostui/tailwindcss */ "./node_modules/@frostui/tailwindcss/dist/frostui.mjs");
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    function initComponents() {
      // Back To Top
      var mybutton = document.querySelector('[data-toggle="back-to-top"]');
    ...
    value: function initModals() {
      var elms = document.querySelectorAll('[data-modal="fb-modal"]');
      ...
      elms.forEach(function (el) {
        var modal = new flowbite__WEBPACK_IMPORTED_MODULE_1__.Modal(el, options);
      });
    }
  }, {
    key: "initSnackbar",
    value: function initSnackbar(res) {}
  }, {
    key: "switchSnackbar",
    value: function switchSnackbar(res) {
      ...
      return "<div class=\"inner ".concat((_response = response) === null || _response === void 0 ? void 0 : _response.status, "\">\n           <div class=\"icon-wrapper\">\n               <div class=\"icon-box\">\n                   <i class=\"").concat((_response2 = response) === null || _response2 === void 0 ? void 0 : _response2.icon, "\"></i>\n               </div>\n           </div>\n           <div class=\"text\">").concat((_response3 = response) === null || _response3 === void 0 ? void 0 : _response3.message, "</div>\n        </div>");
    }
    ...
    value: function init() {
      ...
      var switchSnackbar = function switchSnackbar(res) {
        return _this.switchSnackbar(res);
      };
      document.addEventListener("livewire:init", function () {
        var cancel = document.querySelectorAll('[wire\\:click="closeModal"]');
        var removeModal = document.querySelector('[wire\\:click="cancelDestroy"]');
        Livewire.hook("request", /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
            var uri, options, payload, respond, succeed, fail;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  uri = _ref.uri, options = _ref.options, payload = _ref.payload, respond = _ref.respond, succeed = _ref.succeed, fail = _ref.fail;
                  _context.next = 3;
                  return (0,_frostui_tailwindcss__WEBPACK_IMPORTED_MODULE_0__.initFrost)();
                case 3:
                  respond(function (_ref3) {
                  ...
                  fail(function (_ref5) {
                    var status = _ref5.status,
                      ...
                      preventDefault = _ref5.preventDefault;
        ...
        document.addEventListener("close-modal", function (e) {
          var destroy = e.detail[0].destroy;
          if (destroy) {
            return removeModal.click();
          }
          return cancel.forEach(function (el) {
            el.click();
          });
        });
        document.addEventListener("updated-avatar", function (e) {
          var url = e.detail[0].url;
          var el = document.querySelector("#navbar-avatar");
          el.src = url;
        });
...
var ThemeCustomizer = /*#__PURE__*/function () {
  ...
  _createClass(ThemeCustomizer, [{
    ...
    value: function setSwitchFromConfig() {
      sessionStorage.setItem("panelConfig__", JSON.stringify(this.panelConfig));
...
/* harmony export */   Collapse: () => (/* binding */ C),
/* harmony export */   Dismissable: () => (/* binding */ z),
/* harmony export */   Dropdown: () => (/* binding */ P),
/* harmony export */   Modal: () => (/* binding */ W),
/* harmony export */   Offcanvas: () => (/* binding */ q),
/* harmony export */   Tab: () => (/* binding */ tt),
/* harmony export */   ThemeSwitcher: () => (/* binding */ lt),
/* harmony export */   Tooltip: () => (/* binding */ j),
/* harmony export */   initFrost: () => (/* binding */ _e)
/* harmony export */ });
...
/******/ 	__webpack_require__.O(undefined, ["assets/panel/css/app"], () => (__webpack_require__("./resources/dist/panel/js/main.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["assets/panel/css/app"], () => (__webpack_require__("./resources/dist/panel/scss/app.scss")))
